                            ...
                            <View style={styles.boxUser} >
                                <View style={[styles.boxCenterUser], {justifyContent:"center", alignItems:"center"}}>
                                    ...
                                    <View style={{justifyContent:"center", alignItems:"center"}}>
                                        <Text style={{ textAlign: 'center', fontSize:40, color:"#CDCDC7" }}>
                                            ádasdasdasdasd
                                        </Text>
                                    </View>
                                </View >
                            ...
                            <View style={{width:"95%", justifyContent:"center", alignItems:"center"}}>
                                <View style={{flexDirection:"row", justifyContent:"center", alignItems:"center"}}>
                                    <View style={{width:"25%", alignItems:"center", justifyContent:"center"}}>
                                        <Foundation name="checkbox" size={30} color='white'  />
                                        <Text style={{color:'white'}}>Đã đặt</Text>
                                    </View>
                                    <View style={{width:"25%", alignItems:"center"}}>
                                        <AntDesign name="inbox" size={30} color='white' />
                                    ...
                                    <View style={{width:"25%", alignItems:"center"}}>
                                        <MaterialCommunityIcons name="emoticon-outline" size={30} color='white' />
