...
export default function CheckoutPage({ navigation,route }) {
    ...
    return (
        <View style={styles.container}>  
            <ImageBackground source={require("./../../../../public/pexels-karolina-grabowska-4040652.jpg")} style={{flex:1, resizeMode:"cover"}}>
            <Modal 
                isVisible={modal} 
                ...
                <View style={styles.modal}>
                                ...
                                <View style={{width:"70%"}}>
                                    <Picker
                                        ...
                                        onValueChange={  (item) => {
                                            ...
                                            {AP !="" ? (<Picker.Item style={{fontSize:11}} label={AP} key={1111111} value={'tinh thanh'} />)
                                ...
                                <View style={{width:"70%"}}>
                                    <Picker
                                        ...
                                        onValueChange={ async (item) => {
                                            setAD(item.Title)
                                            await getWard(item.ID)
                                        }}>
                                            {AD !="" ? (<Picker.Item style={{fontSize:11}} label={AD} key={1111111} value={'tinh thanh'} />)
                                ...
                                <View style={{width:"70%"}}>
                                    <Picker
                                        ...
                                        onValueChange={(item) => {
                                            ...
                                            {AW !="" ? (<Picker.Item style={{fontSize:11}} label={AW} key={1111111} value={'tinh thanh'} />)
                                            
                                            : (<Picker.Item style={{fontSize:11}} label="Chọn xã phường thị trấn"  key={1111111} value={'tinh thanh'} />)}
                                            {
                                            ward.map( (v)=>{
                                                return <Picker.Item style={{fontSize:11}} label={v.Title} key={v.ID} value={v} />
                                            })
                        ...
                        <View style={{justifyContent:"center", alignItems:"center", marginTop:"5%", flexDirection:"row"}}>
                            <Button
                                ...
                                title="Chọn làm địa chỉ gao hàng"
                                type="solid"
                                onPress={()=>{
                ...
                <TouchableNativeFeedback onPress={()=>alert("Địa chỉ")} style={{borderBottomWidth:.5,borderBottomColor:"#C4CCDF"}}>
                    <View style={styles.boxAddress}>
                        ...
                        <View style={{flexDirection:"row",padding:"3%"}}>
                            ...
                            <View style={{width:"70%"}}>
                                <Text style={{marginLeft:"3%"}}>{ AH } / { AW } / { AD } / { AP }</Text>
                            </View>
                            <View style={{width:"20%"}}>
